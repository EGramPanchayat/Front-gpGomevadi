  ...
  return (
    ...
    >
      <div className="max-w-7xl w-full mx-auto px-4">
        ...
        {/* Sarpanch & Upsarpanch */}
        {(board.sarpanch || board.upsarpanch) && (
        ...
        {board.staff?.officers?.length > 0 && (
          <div className="w-full mt-16 border-t pt-10 border-slate-200">
            <h3 className="text-3xl md:text-[2.5rem] font-bold text-green-700 text-center mb-10 relative">
              कर्मचारी
              <span className="block w-24 h-1 bg-orange-400 rounded absolute left-1/2 -translate-x-1/2 -bottom-3"></span>
            </h3>
